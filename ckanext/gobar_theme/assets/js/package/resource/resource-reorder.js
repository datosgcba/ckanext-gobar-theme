...
this.ckan.module('resource-reorder-badata', function($) {
  return {
    options: {
      id: false
    },
    ...
    initialize: function() {
      ...
      var labelText = this._('Reordenar Recursos');
      var helpText = this._('Puedes reorganizar los recursos arrastrándolos usando el ícono de flecha. ' +
                'Arrastrar el recurso a la derecha y colóquelo en la ubicación deseada en la lista. '+
                'Cuando haya terminado, haga clic en el botón "Guardar Orden". ');
      ...
      $('span', this.html_saving).text(this._('Guardando...'));
